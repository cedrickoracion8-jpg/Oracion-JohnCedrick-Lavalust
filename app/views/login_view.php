...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card {
            background: linear-gradient(135deg, #064e3b 0%, #10b981 100%); /* Dark green → Emerald gradient */
            width: 100%;
            max-width: 380px;
        ...
        input:focus { outline: none; border-color: #34d399; box-shadow: 0 0 6px #34d399; }
        button {
            width: 100%;
            padding: .7rem;
        ...
        button:hover { background: linear-gradient(90deg, #047857, #34d399); }
        .msg {
            padding: .7rem .9rem;
            border-radius: 8px;
            font-size: .85rem;
        ...
        .footer-link { text-align: center; margin-top: 1.25rem; font-size: .85rem; color: #a7f3d0; }
